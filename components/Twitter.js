      ...
      <div className="flex flex-col justify-center items-center my-10">
        <div>
          <div className="flex justify-between items-center">
            ...
            <a href={croppedImageTweet} download className="h-11 w-11 rounded-lg border cursor-pointer hover:bg-gray-200 dark:border-gray-500 dark:hover:bg-gray-800 transition flex justify-center items-center">
              <svg
      ...
      <div className="flex flex-col justify-center items-center my-10 mb-16">
        <div>
          <div className="flex justify-between items-center">
            ...
            <a href={croppedImageCard} download className="h-11 w-11 rounded-lg border cursor-pointer hover:bg-gray-200 dark:border-gray-500 dark:hover:bg-gray-800 transition flex justify-center items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
